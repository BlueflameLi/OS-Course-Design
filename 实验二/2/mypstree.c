...
{
    struct task_struct *pchildren[100];
...
static void mypstree_exit(void)
{
    printk(KERN_ALERT "mypstree exit\n");
}

module_init(mypstree_init);
module_exit(mypstree_exit);
MODULE_LICENSE("GPL");
